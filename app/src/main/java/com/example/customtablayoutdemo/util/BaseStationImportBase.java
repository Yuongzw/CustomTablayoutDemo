...
public abstract class BaseStationImportBase {
	...
	public enum COLNAME {
		...
		EARFCN, PCI, ENODEBID, ENODEBIP, SECTORID,ENBID_LCELLID,SSB_ARFCN,Center_ARFCN,NARFCN,GNODEBID,
        G_NODEB,G_NB,NSA,SA,SSB,NCI,TAC,SITEID
	}
	...
	public String getStringValue(String[] values, Map<COLNAME, Integer> colMap, COLNAME colName) {
		if (colMap.containsKey(colName)) {
			...
			if (index < values.length && !TextUtils.isEmpty(values[index])) {
